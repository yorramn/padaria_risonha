...
@section('title','Registrar encomenda')
@section('content')
<div class="section">
    <div class="row">
        <form action="/encomenda/create" class="col s12" method="POST" name="venda" id="form">
            @csrf
            ...
            <div class="row ">
                ...
                <div class="input-field col s6 m6 l3 xl3">
                    <i class="material-icons prefix">account_circle</i>
                    <input id="data_de_pagamento" type="date" class="validate" name="data_de_pagamento">
                    <label for="data_de_pagamento">Data do Pagamento</label>
                </div>
                <div class="input-field col s6 m6 l3 xl3">
                    <i class="material-icons prefix">account_circle</i>
                    <input id="data_de_recebimento" type="date" class="validate" name="data_de_recebimento">
                    <label for="data_de_recebimento">Data do Recebimento</label>
                </div>
